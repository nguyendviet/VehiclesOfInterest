...
public class VehiclesOfInterestController {
    ...
    */  
    ...
    public void deleteReasonForInterestBreed(String reason) throws Exception
    /*
    ...
    public void deleteVehicleMake(String make) throws Exception
    /*
    ...
    public void deleteVehicleModel(String model) throws Exception
    /*
    ...
    public void deleteVehicleOfInterest(String licensePlate) throws Exception
    /*
    ...
    public void createReasonOfInterest(String reason, String description) throws Exception
    /*
